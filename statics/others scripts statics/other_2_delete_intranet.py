...
def remove_login_tag(infile_path, outfile_path, files_directory):
    ...
    with open(infile_path, 'r') as archive:
        ...
        # s = soup.find('a', href=re.compile("index.html"))

        s = soup.find('a', href=re.compile(files_directory))
        if s is not None:
...
if __name__ == '__main__':
    ...
    for fpath in files_list:
        ...
        remove_login_tag(fpath, fpath, files_directory)
